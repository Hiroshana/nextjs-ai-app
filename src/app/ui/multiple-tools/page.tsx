                    ...
                    case "input-streaming":
                      return (
                        <div
                          ...
                          className="bg-zinc-300/50 border border-zinc-700 p-2 rounded mt-1 mb-2"
                        >
                      ...
                      return (
                        ...
                        >
                          <div className="text-sm text-zinc-400">
                            Getting location for for {part.input.name}...
                          </div>
                        </div>
                      );
                    ...
                    case "output-available":
                      return (
                        <div
                          ...
                          className="bg-zinc-300/50 border border-zinc-700 p-2 rounded mt-1 mb-2"
                        >
                          <div className="text-sm text-zinc-800">Weather</div>
                          <div className="text-sm text-zinc-400">
                            <div>{part.output}</div>
                          </div>
                        </div>
...
export default MultipleToolChatPage;
